...
creates and modifies data request information into RDADB
...
|          [:ref:`-(DQ|DateReuqest) <DQ>` DateSubmitted]
|          [:ref:`-(TQ|TimeReuqest) <TQ>` TimeSubmitted]
...
.. list-table::
   ...
   * - :ref:`-(NR|NewReqeust) <NR>`
     - sets a new request record into RDADB for given dataset, group index and request type
...
| **dsrqst** :ref:`SR <SR>` :ref:`-RI <RI>` 0 :ref:`-NR <NR>` :ref:`-DS <DS>` dsnnn.n :ref:`-EM <EM>` UserEmail :ref:`-DF <DF>` DataFormat :ref:`-RS <RS>` Q :ref:`-RT <RT>` C

then change directory to where data files sit and build the request by running
command

| **dsrqst** :ref:`BR <BR>` :ref:`-RI <RI>` NewAddedRequestIndex :ref:`-LF <LF>` DataFileList
