...
.. list-table::
   ...
   * - :ref:`-(NC|NewRequest) <NC>`
     - sets a new request control record into RDADB for given dataset, group index, and request type
...
record is added if control index is 0 and :ref:`Mode option <section4>` :ref:`-NC <NC>` (-NewControl) is present.
